...
BEGIN
  ...
  WHERE n.nspname = 'public'
    ...
    AND oidvectortypes(p.proargtypes) = 'uuid, uuid, jsonb, jsonb, jsonb, uuid, jsonb, jsonb';

  IF _function_oid IS NULL THEN
    RAISE EXCEPTION 'Expected function public.submit_public_job_application(uuid, uuid, jsonb, jsonb, jsonb, uuid, jsonb, jsonb) was not found';
  END IF;
