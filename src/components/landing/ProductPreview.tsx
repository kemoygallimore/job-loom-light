import { Play, FileText, Users, Star } from "lucide-react";

const candidates = [
  { name: "Mia Thompson", role: "Senior UX Designer", rating: 5, status: "Shortlisted" },
  { name: "Daniel Park", role: "Full-Stack Engineer", rating: 4, status: "Reviewed" },
  { name: "Aisha Mohammed", role: "Product Manager", rating: 4, status: "Pending" },
  { name: "Lucas Rivera", role: "Data Scientist", rating: 5, status: "Shortlisted" },
  { name: "Emma Watson", role: "DevOps Engineer", rating: 3, status: "Reviewed" },
];
            ...
            <div className="md:col-span-2 p-4 space-y-4">
              ...
              <div className="bg-muted/40 rounded-xl p-4 border">
                ...
                <div className="space-y-2">
                  {["Experience", "Education", "Skills", "Projects"].map((s) => (
                    <div key={s} className="flex items-center gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-primary/40" />
                      <div className="h-2 bg-muted rounded-full" style={{ width: `${60 + Math.random() * 30}%` }} />
                    </div>
                  ))}
                </div>
              </div>
